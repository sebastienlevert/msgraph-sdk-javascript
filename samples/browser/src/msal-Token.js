var ms = (function(exports, msal) {
	...
	***************************************************************************** */
	...
	var ImplicitMSALAuthenticationProvider = /*#__PURE__*/ (function() {
		/**
		 * @public
		 * @constructor
		...
		function ImplicitMSALAuthenticationProvider(msalApplication, options) {
			classCallCheck(this, ImplicitMSALAuthenticationProvider);
		...
		createClass(ImplicitMSALAuthenticationProvider, [
			{
				key: "getAccessToken",
				value: function getAccessToken(authenticationProviderOptions) {
					return __awaiter(
						this,
						void 0,
						void 0,
						/*#__PURE__*/ regenerator.mark(function _callee() {
							var options, scopes, error, tokenRequest, authResponse, _authResponse, _tokenRequest, _authResponse2;
									...
									while (1) {
										switch ((_context.prev = _context.next)) {
											...
											case 13:
												...
												return _context.abrupt("return", authResponse.accessToken);

											case 17:
												_context.prev = 17;
												_context.t0 = _context["catch"](10);

												if (!(_context.t0 instanceof msal.InteractionRequiredAuthError)) {
													_context.next = 32;
													break;
												}
												...
												_context.prev = 20;
												_context.next = 23;
												return this.msalApplication.acquireTokenPopup(tokenRequest);

											case 23:
												_authResponse = _context.sent;
												return _context.abrupt("return", _authResponse.accessToken);
											...
											case 35:
												...
												_context.next = 39;
												return this.msalApplication.loginPopup(_tokenRequest);

											case 39:
												_context.next = 41;
												return this.msalApplication.acquireTokenSilent(_tokenRequest);

											case 41:
												_authResponse2 = _context.sent;
												return _context.abrupt("return", _authResponse2.accessToken);
	 ...
	 */
	var MSALAuthenticationProviderOptions =
		/**
		 * @public
		 * @constructor
		...
		function MSALAuthenticationProviderOptions(scopes) {
			classCallCheck(this, MSALAuthenticationProviderOptions);
